...
### Backend Developer • Machine Learning Engineer • System Designer

Building scalable systems, AI-powered applications, and modern developer tools.
...
- 🧠 Exploring Machine Learning and LLM applications
- ⚡ Learning Elixir, Phoenix, and distributed systems
- 🌍 Interested in scalable architectures and cloud-native solutions
- 📚 Constantly improving through open source and research
...
|----------|-------------|------|
| DeepSeek-V3 | AI experimentation and LLM research | Python |
| Blog Generator | Automated content generation platform | Python |
| Software Project | Backend architecture showcase | Python |
| MacDevs | Community-driven software initiatives | Elixir |
| Future Phoenix App | Real-time web applications | Elixir + Phoenix |
...
- Launch MacDevs community platform
